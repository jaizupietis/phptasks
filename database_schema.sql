...
CREATE TABLE `notifications` (
  ...
  KEY `fk_notification_problem` (`problem_id`),
  CONSTRAINT `fk_notification_problem` FOREIGN KEY (`problem_id`) REFERENCES `problems` (`id`) ON DELETE SET NULL,
...
(41,3,30,NULL,'task_assigned','New Task Assigned','New task: \'Tests ceturtdien\'',0,'2025-07-10 06:12:35','normal',NULL),
(42,1,NULL,11,'problem_reported','New Problem Reported','Problem: \'Neiet 1.ēvele\'',0,'2025-07-10 11:54:38','normal',NULL),
(43,2,NULL,11,'problem_reported','New Problem Reported','Problem: \'Neiet 1.ēvele\'',0,'2025-07-10 11:54:38','normal',NULL);
...
CREATE TABLE `problems` (
  ...
  KEY `idx_problems_status_priority` (`status`,`priority`),
  KEY `idx_problems_reported_by_status` (`reported_by`,`status`),
  KEY `idx_problems_assigned_to_status` (`assigned_to`,`status`),
...
(1,'Hydraulic leak in Unit A','Noticed hydraulic fluid pooling under Unit A during morning inspection. Appears to be from main cylinder.','high','reported','Hydraulic System','Workshop Bay 1','Excavator Unit A',5,NULL,NULL,NULL,'major','high','high',NULL,NULL,NULL,NULL,'2025-07-10 05:47:36','2025-07-10 05:47:36',NULL,NULL,NULL,NULL),
(2,'Unusual noise from conveyor belt','Grinding noise coming from conveyor belt motor. Getting progressively worse over past 2 days.','medium','reported','Mechanical','Production Line 2','Conveyor Belt #3',5,NULL,NULL,NULL,'moderate','medium','medium',NULL,NULL,NULL,NULL,'2025-07-10 05:47:36','2025-07-10 05:47:36',NULL,NULL,NULL,NULL),
(3,'Engine overheating warning','Temperature gauge showing red, automatic shutdown triggered twice today.','urgent','reported','Engine','Yard Area B','Mobile Crane MC-01',5,NULL,NULL,NULL,'critical','critical','urgent',NULL,NULL,NULL,NULL,'2025-07-10 05:47:36','2025-07-10 05:47:36',NULL,NULL,NULL,NULL),
(4,'Brake system soft pedal','Brake pedal goes to floor, requires pumping to get stopping power. Safety concern.','urgent','reported','Brake System','Vehicle Fleet','Forklift FL-05',5,NULL,NULL,NULL,'major','critical','urgent',NULL,NULL,NULL,NULL,'2025-07-10 05:47:36','2025-07-10 05:47:36',NULL,NULL,NULL,NULL),
(5,'Oil pressure warning light','Oil pressure warning light comes on intermittently during operation.','high','reported','Engine','Workshop Bay 3','Generator Set GS-02',5,NULL,NULL,NULL,'moderate','high','high',NULL,NULL,NULL,NULL,'2025-07-10 05:47:36','2025-07-10 05:47:36',NULL,NULL,NULL,NULL),
(6,'Hydraulic leak in Unit A','Noticed hydraulic fluid pooling under Unit A during morning inspection. Appears to be from main cylinder.','high','reported','Hydraulic System','Workshop Bay 1','Excavator Unit A',5,NULL,NULL,NULL,'major','high','high',NULL,NULL,NULL,NULL,'2025-07-10 10:34:04','2025-07-10 10:34:04',NULL,NULL,NULL,NULL),
(7,'Unusual noise from conveyor belt','Grinding noise coming from conveyor belt motor. Getting progressively worse over past 2 days.','medium','reported','Mechanical','Production Line 2','Conveyor Belt #3',5,NULL,NULL,NULL,'moderate','medium','medium',NULL,NULL,NULL,NULL,'2025-07-10 10:34:04','2025-07-10 10:34:04',NULL,NULL,NULL,NULL),
(8,'Engine overheating warning','Temperature gauge showing red, automatic shutdown triggered twice today.','urgent','reported','Engine','Yard Area B','Mobile Crane MC-01',5,NULL,NULL,NULL,'critical','critical','urgent',NULL,NULL,NULL,NULL,'2025-07-10 10:34:04','2025-07-10 10:34:04',NULL,NULL,NULL,NULL),
(9,'Brake system soft pedal','Brake pedal goes to floor, requires pumping to get stopping power. Safety concern.','urgent','reported','Brake System','Vehicle Fleet','Forklift FL-05',5,NULL,NULL,NULL,'major','critical','urgent',NULL,NULL,NULL,NULL,'2025-07-10 10:34:04','2025-07-10 10:34:04',NULL,NULL,NULL,NULL),
(10,'Oil pressure warning light','Oil pressure warning light comes on intermittently during operation.','high','reported','Engine','Workshop Bay 3','Generator Set GS-02',5,NULL,NULL,NULL,'moderate','high','high',NULL,NULL,NULL,NULL,'2025-07-10 10:34:04','2025-07-10 10:34:04',NULL,NULL,NULL,NULL),
(11,'Neiet 1.ēvele','cxcxc','high','reported','Electrical','2','',5,NULL,NULL,NULL,'moderate','low','low',NULL,4,NULL,NULL,'2025-07-10 11:54:38','2025-07-10 11:54:38',NULL,NULL,NULL,NULL);
...
(30,'Tests ceturtdien',NULL,'medium','pending',3,2,'Installation','M2','Skrūves',NULL,NULL,'2025-07-10 07:12:00','2025-07-11 07:12:00',NULL,0,NULL,'2025-07-10 06:12:35','2025-07-10 06:12:35',NULL,NULL);
...
(1,'admin','admin@company.com','admin123','System','Administrator','admin','+1234567890','IT',1,'2025-07-10 10:40:31','2025-07-08 09:55:10','2025-07-10 10:40:31',NULL,NULL),
(2,'manager1','manager1@company.com','manager123','John','Manager','manager','+1234567891','Operations',1,'2025-07-10 11:55:12','2025-07-08 09:55:10','2025-07-10 11:55:12',NULL,NULL),
(3,'mechanic1','mechanic1@company.com','mechanic123','Mike','Smith','mechanic','+1234567893','Field Operations',1,'2025-07-10 11:16:09','2025-07-08 09:55:10','2025-07-10 11:16:09',NULL,NULL),
...
(5,'operator1','operator1@company.com','operator123','Sarah','Wilson','operator',NULL,'Operations',1,'2025-07-10 11:53:51','2025-07-10 05:47:36','2025-07-10 11:53:51',NULL,NULL);
...
-- Dump completed on 2025-07-10 15:01:41
